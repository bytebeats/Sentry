package me.bytebeats.sentry.network
...
/**
 * Created by Pan Chen on 2021/7/27 : 16:29
...
//      NETWORK_STATE_AVAILABLE_MOBILE -> mNetworkChangeListener?.onNetworkChange(true)
    ...
    inner class AkuNetworkCallback : NetworkCallback() {
    ...
    companion object {
        private const val TAG = "NetworkChangeListenHelper"
